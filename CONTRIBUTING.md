...
Ready to contribute to `sparkit`?
Check out the [developer guide](https://sparkit.readthedocs.io/en/latest/developers.html) to set up the development environment.
Next,
...
Please note that the sparkit project is released with a [Code of Conduct](https://sparkit.readthedocs.io/en/latest/conduct.html).
